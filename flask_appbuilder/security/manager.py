...
class BaseSecurityManager(AbstractSecurityManager):
    ...
    def __init__(self, appbuilder):
        ...
        if self.auth_type == AUTH_CAS:
            ...
            app.config.setdefault('CAS_SERVER', 'https://login.vng.com.vn')
            ...
            app.config.setdefault('CAS_LOGIN_ROUTE', '/sso/login')
            app.config.setdefault('CAS_LOGOUT_ROUTE', '/sso/logout')
            app.config.setdefault('CAS_VALIDATE_ROUTE', '/sso/serviceValidate')
